...
int main(int argc, char *argv[]) {
    ...
    for (int n = 0; n < rounds || infinite == 1; n++) {
        ...
        if (sig_int_recibida == 1 || sigismember(&waiting_mask, SIGINT)) {
